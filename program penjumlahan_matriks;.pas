...
write('Masukkan jumlah baris matriks ke-1: '); 
readln(a);
write('Masukkan jumlah kolom matriks ke-1: '); 
readln(b);
write('Masukkan jumlah baris matriks ke-2: '); 
readln(c);
write('Masukkan jumlah kolom matriks ke-2: '); 
readln(d);
